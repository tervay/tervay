...
for item in all_items:
    ...
    vars()[route_name] = app.route(f'/share/{url}/', methods=['GET', 'POST'])(vars()[route_name])
    ...
    vars()[json_endpoint] = app.route(f'/share/{url}_json/', methods=['GET', 'POST'])(vars()[json_endpoint])
